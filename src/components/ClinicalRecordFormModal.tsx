      ...
      {step === 1 && (
        <div className="space-y-4">
          ...
          <form onSubmit={handleSearchPatient} className="flex gap-2">
            <div className="relative flex-1 align-center justify-center">
              <input
                type="text"
                placeholder="Buscar por nombre, apellido o cédula..."
                className="w-full pl-10 pr-4 py-2 rounded-lg border border-slate-200 focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary h-11 sm:h-12  text-sm"
          ...
          <div className="mt-4 max-h-60 overflow-y-auto border border-slate-100 rounded-lg">
            {foundPatients.length === 0 && !isSearching && patientSearchTerm && (
              <div className="p-4 text-center text-slate-500 text-sm flex flex-col items-center gap-2">
                ...
                <a
                  ...
                  className="inline-flex items-center gap-2 text-primary border border-primary/30 rounded-lg px-4 py-2 hover:bg-primary/5 transition-colors font-medium mt-2"
                >
            ...
            {foundPatients.length === 0 && !patientSearchTerm && (
              <div className="p-8 text-center text-slate-500 text-sm">
                ...
                <a
                  href={window.location.pathname.includes("/medical") ? "/medical/patients" : "/admin/patients"}
                  className="inline-flex items-center gap-2 text-primary border border-primary/30 rounded-lg px-4 py-2 hover:bg-primary/5 transition-colors font-medium mt-4"
                >
                  <img src={UserIcon.src} alt="" className="w-4 h-4" />
