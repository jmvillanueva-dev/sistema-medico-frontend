...
import { forcePasswordChangeSchema } from "@/lib/validation/auth";
import type { ForcePasswordChangeFormData } from "@/lib/validation/auth";
import { forcePasswordChange } from "@/services/authService";
...
const ForcePasswordChangeForm: React.FC<ForcePasswordChangeFormProps> = ({
  ...
  const onSubmit: SubmitHandler<ForcePasswordChangeFormData> = async (data) => {
    setIsLoading(true);
